...
namespace ChainOfResponsibility
{
    public class Document
    {
        ...
        public Document(string title, DateTime lastModified, bool approvedByLitigation, bool approvedByManagement)
        {
            Title = title;
    ...
    public class DocumentLastModifiedHandler : IHandler<Document>
    {
        ...
        public void Handle(Document document)
        {
            ...
            {
                throw new ValidationException(new ValidationResult("Document must be modified in last 30 days", new List<string>() { "LastModified" }), null, null);
            }
